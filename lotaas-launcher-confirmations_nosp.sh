...
do	
	...
	then
	    ...
	    sbatch $LOTAAS_PL/lotaas_fil_confirmations_nosp.sh $1 ${sap} ${beam}  >job_id_$1.txt
...
#copying heatmap plots to pcands
cp *heatmap*.png TA*.png /projects/0/lotaas2/data/pcands/confirmations/$1
