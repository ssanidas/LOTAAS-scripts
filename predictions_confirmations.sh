...
#output directory
outdir="/projects/0/lotaas2/data/pcands/confirmations"
...
#Tarball creation for transferring the results
#cd $outdir
#mkdir ${obsid}_png
#cp $obsid/*.png ${obsid}_png
#tar -cf ${obsid}_png.tar.gz ${obsid}_png
#mv ${obsid}_png.tar.gz /projects/0/lotaas2/data/out/check
#rm -rf ${obsid}_png