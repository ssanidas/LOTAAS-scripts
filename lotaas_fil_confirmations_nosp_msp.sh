...
#		echo "rednoise $file >> $file.log" >> process_red
	...
	for file in *.fft; do
	    if [ $count -lt 3 ] && [ $bcount -lt $numberOFdms ]
                then
		echo -n "accelsearch -flo 1. -sigma 2 -fhi 1000. -zmax 100 -numharm 16 -harmpolish $file > $file.log;" >> process_accel_$ccount
		let count+=1
	    else
		echo    "accelsearch -flo 1. -sigma 2 -fhi 1000. -zmax 100 -numharm 16 -harmpolish $file > $file.log " >> process_accel_$ccount
		count=0
