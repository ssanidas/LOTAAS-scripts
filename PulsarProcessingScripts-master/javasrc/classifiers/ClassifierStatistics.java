...
public class ClassifierStatistics implements I_ClassifierStatistics
{
	...
	public String toCSV()
	{
		return this.TP + "," + this.TN + "," + this.FP + "," + this.FN + "," + this.accuracy + "," + this.precision + "," + this.recall +","+
				this.specificity + "," + this.negativePredictiveValue + "," + this.matthewsCorrelation + "," + this.fScore + "," + this.gmean + "," + this.kappa;
	}
}
