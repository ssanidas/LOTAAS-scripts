 ...
 *
 * File name: 	I_ClassifierStatistics.java
...
/**
 * I_ClassifierStatistics provides an interface for
 * providing the statistics needed to describe the accuracy
 * of a classifier. 
 * 
 * The statistics are calculated using the true positive, true negative,
 * false positive and false negative counts. These are defined as:
 * 
 * True Positives (TP) = those input patterns correctly classified as pulsars.
 * True Negatives (TN) = those input patterns correctly classified as NOT pulsars.
 * False Positives (FP) = those input patterns incorrectly classified as pulsars.
 * False Negatives (FN) = those input patterns incorrectly classified as NOT pulsars.
 * 
 * @author Rob Lyon
 * 
...
public interface I_ClassifierStatistics
{
	 ...
	 * as the proportion of input patterns identified as not pulsars, that are correctly
	 ...
	 * the proportion of input patterns identified as not pulsars, that are correctly
	 * identified as such. A high NPV means that when the map yields a negative result,
	 * it is most likely correct in its assessment.
	...
	/**
	 * Gets the kappa statistic where,
	 * 
