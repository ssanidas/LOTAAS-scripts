...
class PHCXOperations(ProfileOperations):
    """                
    ...
    def getSubbandParameters(self,section,data=None,profile=None):
        ...
        RMS,mean_corr = self.getSubband_scores(subbands, prof_bins, band_subbands, bestWidth)
    ...
    def getDMCurveData(self,data,section):
        ...
        # Extract DM curve.
        dm_curve_all = array(self.getDM_FFT(data,0))
        return dm_curve_all
