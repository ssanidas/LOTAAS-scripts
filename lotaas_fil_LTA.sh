...
OUTDIR=/projects/0/lotaas/data/out/$1/SAP$2
time {
...
#    masterrfifile=/home/sanidas/LOTAAS-Scripts/master.rfi
    ...
    python /home/sanidas/LOTAAS-Scripts/psrfits2fil.py --noscales --noweights --nooffsets /projects/0/lotaas/data/raw/${obsfile}_red/$stokes/SAP${subarray}/BEAM${beam}/${obsfile}_SAP${subarray}_BEAM${beam}.fits -o ${obsfile}_SAP${subarray}_BEAM${beam}.fil
    ...
    cp $HOME/LOTAAS-Scripts/parallel.sh . 
    cp $HOME/LOTAAS-Scripts/realfft.sh . 
    cp $HOME/LOTAAS-Scripts/rednoise.sh .
    cp $HOME/LOTAAS-Scripts/single_pulse_search_lotaas.py .
...
python /home/sanidas/scripts/scores_robLyon/PulsarProcessingScripts-master/src/CandidateScoreGenerators/ScoreGenerator.py -c $OUTDIR/$outname_mpi/ --pfd --dmprof --arff -o $OUTDIR/$outname_mpi/dmprof_$beam.arff 
